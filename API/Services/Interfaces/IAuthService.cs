...
namespace API.Services.Interfaces
{
    public interface IAuthService
    {
        ...
        Task<(bool Success, string Message, int StatusCode, string accessToken, string refreshToken, string userId, bool hasActiveContract, bool hasTerminatedContract, string BuildingName, string BuildingID)> LoginAsync(LoginRequest loginRequest);
